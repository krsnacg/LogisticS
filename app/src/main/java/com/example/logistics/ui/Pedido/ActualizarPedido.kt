        ...
        LazyColumn (
            ...
            item {
                OutlinedTextField(
                    ...
                    onValueChange = {},
                    label = {
                        Text(text = stringResource(id = R.string.campo_codigo_empleado))
                    },
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(start = 20.dp, end = 20.dp, bottom = 20.dp)
            ...
            item {
                ...
                Box(
                    ...
                    Button(
                        ...
                        Text(text = stringResource(id = R.string.boton_actualizar_pedido))
                    }
                }
            }
...
@Composable
fun ActualizarPedidoLightPreview() {
    LogisticSTheme (darkTheme = false) { ActualizarPedido() }
}

@Preview(showBackground = true, showSystemUi = false)
@Composable
fun ActualizarPedidoDarkPreview() {
    LogisticSTheme (darkTheme = true) { ActualizarPedido() }
}